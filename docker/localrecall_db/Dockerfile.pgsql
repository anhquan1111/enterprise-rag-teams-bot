# =============================================================================
# Dockerfile.pgsql — Postgres 18 image cho LocalRecall hybrid search.
# Mirrored từ mudler/LocalRecall (main branch) để bảo đảm tương thích chính xác
# với Go engine của LocalRecall — đặc biệt extension `pg_textsearch` (Timescale)
# mà LocalRecall yêu cầu cho BM25 indexing.
# Bao gồm: PostgreSQL 18 + pg_textsearch + pgvector + pgvectorscale + timescaledb.
# =============================================================================
